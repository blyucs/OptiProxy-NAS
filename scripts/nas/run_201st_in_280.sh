...
cp -f $cur_project_dir/p201-0/$dataset/configs/predictors/config_gcn_search_train_280.yaml $cur_project_dir/p201-0/$dataset/configs/predictors/config_gcn_search_train.yaml
