...
best_arch_test_acc = search_model.best_arch.query(metric=Metric.TEST_ACCURACY, dataset=config.dataset,
                                               dataset_api=dataset_api,
                                               sample_mean=config.sample_mean)
logger.info(f"Seed {config.seed}, search step: {step}, best arch's corr test_acc: {best_arch_test_acc} best_acc: {search_model.best_acc}")
